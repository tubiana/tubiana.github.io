...
def card_text(repo_id: str, code_url: str, viewer_url: str, prov: dict, stats: dict, arts: dict, csv_name: str) -> str:
    ...
    return f"""---
license: mit
pretty_name: "Hepatitis E virus ORF1 — AlphaFold2 model collection"
tags:
  - hepatitis-e
  - orf1
  - alphafold2
...
# Hepatitis E virus ORF1 — AlphaFold2 model collection

**{stats['models']:,}** AlphaFold2 predictions of the HEV ORF1 polyprotein, packaged so a
